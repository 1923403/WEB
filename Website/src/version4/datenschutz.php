<?php include_once ("header.php") ?>
    ...
    <div class="content">
        ...
        <p>
            Unserer Webseite kann selbstverständlich genutzt werden, ohne dass Sie persönliche Daten angeben. Wenn
            jedoch zu irgendeinem Zeitpunkt persönliche Daten wie z.B. Name, Adresse oder E-Mail abgefragt werden, wird
            dies auf freiwilliger Basis geschehen. Niemals werden von uns erhobene Daten ohne Ihre spezielle Genehmigung
        ...
        <p>
            ...
            Thema stehen wir Ihnen ebenfalls jederzeit zur Verfügung.
        </p>
        ...
        <p>
            ...
            Einfügung neuer Angebote. Für Ihren nächsten Besuch gilt dann automatisch die neue Datenschutzerklärung.
        </p>
        <h3>Kontakt zum Datenschutz</h3>
        <p>
